...
public class ActivityTopicView extends ListActivity implements Runnable, ShackGestureEvent
{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null)
		{
			...
			{
				new AlertDialog.Builder(this).setTitle("Error").setPositiveButton("OK", null).setMessage("There was an error connecting to the API.").show();
				try
				{
					dismissDialog(1);
				} catch (Exception ex)
		...
		case 10: // show shack messages if they enabled them
			...
			} else
			{
				new AlertDialog.Builder(this)
						...
						.setMessage(
								"Shack Messages posts your credentials to the API " + "instead of directly ShackNews.\n\n If you agree with this "
										+ "you can enable this feature under \"Settings\".").show();
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		case 3:
			...
			new AlertDialog.Builder(this).setTitle("Thread Will Expire In:").setMessage(Helper.GetTimeLeftString(post.getPostDate())).setNegativeButton("OK", null).show();
			...
			v.setOnItemLongClickListener(new OnItemLongClickListener() {
				...
				public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
					try
					{
						...
						new AlertDialog.Builder(view.getContext()).setTitle("Remove Watched Topic").setMessage("Are you sure you wish to remove this watched topic?")
